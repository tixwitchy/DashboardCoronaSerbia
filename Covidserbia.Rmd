...
izleceni<-25882-as.numeric(scrapingdead2[which(scrapingdead2=="БРОЈ СМРТНИХ СЛУЧАЈЕВА")-1])
...
Row {data-height=815} 
-----------------------------------------------------------------------
### **Mapa sa ukupnim brojem zaraženih po opštinama na dan `r format(Sys.Date()-52,"%d.%m.")`**
...
-----------------------------------------------------------------------
### **Broj slučajeva po opštinama u Beogradu na dan `r format(Sys.Date()-52,"%d.%m.")`** 
