...
izleceni<-18983-as.numeric(str_replace(scrapingdead2[which(scrapingdead2=="БРОЈ АКТИВНИХ СЛУЧАЈЕВА")-1],"\\,",""))-as.numeric(scrapingdead2[which(scrapingdead2=="БРОЈ СМРТНИХ СЛУЧАЈЕВА")-1])
...
Row {data-height=815} 
-----------------------------------------------------------------------
### **Mapa sa ukupnim brojem zaraženih po opštinama na dan `r format(Sys.Date()-34,"%d.%m.")`**
...
-----------------------------------------------------------------------
### **Broj slučajeva po opštinama u Beogradu na dan `r format(Sys.Date()-34,"%d.%m.")`** 
