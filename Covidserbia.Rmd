...
Row {data-height=815} 
-----------------------------------------------------------------------
### **Mapa sa ukupnim brojem zaraženih po opštinama na dan `r format(Sys.Date()-32,"%d.%m.")`**
...
-----------------------------------------------------------------------
### **Broj slučajeva po opštinama u Beogradu na dan `r format(Sys.Date()-32,"%d.%m.")`** 
