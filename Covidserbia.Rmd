...
valueBox("preko 200",color = "green")#,href="http://rs.n1info.com/Vesti/a582261/Koronavirus-u-Srbiji-Interaktivni-grafikoni-sa-brojem-zarazenih-po-gradovima.html")
```
...
Row {data-height=815} 
-----------------------------------------------------------------------
### **Mapa sa ukupnim brojem zaraženih po gradovima do 29.03.**
...
m<-leaflet(covidserbiamap) %>% 
  ...
  addCircles(radius = ~`sum(Vrednost)`^(.5)*1000,weight = 1, color = "black",
             fillColor = "red", fillOpacity = 0.6,  
             popup = ~paste("Grad:", `NazivTeritorije`, "<br>","Broj slučajeva:",`sum(Vrednost)`, "<br>"))
...
### **Broj novih slučajeva - gradovi po danima do 29.03.**
